def validate_guess(guess, word_length=5):
    ...
    >>> wordle_yd2798.validate_guess("hello")
    True
    >>> wordle_yd2798.validate_guess("HELLO")
    False
    >>> wordle_yd2798.validate_guess("hi")
    False
    >>> wordle_yd2798.validate_guess("test!")
    False
...
def check_guess(secret_word, guess):
    ...
    --------
    >>> from wordle_yd2798 import wordle_yd2798
    >>> wordle_yd2798.check_guess("crane", "crane")
    [('c', 'green'), ('r', 'green'), ('a', 'green'), ('n', 'green'), ('e', 'green')]
    >>> wordle_yd2798.check_guess("crane", "carts")
    [('c', 'green'), ('a', 'yellow'), ('r', 'yellow'), ('t', 'gray'), ('s', 'gray')]
    >>> wordle_yd2798.check_guess("crane", "hello")
